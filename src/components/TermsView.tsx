      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white p-8 md:p-16 rounded-[3rem] border border-gray-100 shadow-vibrant">
          <div className="flex items-center gap-4 mb-8 text-indigo-600">
            ...
            <h1 className="text-4xl md:text-5xl text-[#363636] font-normal leading-[1.2]">Terms of Service</h1>
          </div>
          ...
          <div className="space-y-12 prose prose-slate prose-lg max-w-none">
            <section>
              <div className="flex items-center gap-3 mb-4 text-[#363636]">
                ...
                <h2 className="text-2xl m-0 font-normal leading-[1.2]">1. Acceptance of Terms</h2>
              </div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-[#363636]">
                ...
                <h2 className="text-2xl m-0 font-normal leading-[1.2]">2. Reservation Policy</h2>
              </div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-[#363636]">
                ...
                <h2 className="text-2xl m-0 font-normal leading-[1.2]">3. User Conduct</h2>
              </div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-[#363636]">
                ...
                <h2 className="text-2xl m-0 font-normal leading-[1.2]">4. Limitation of Liability</h2>
              </div>
