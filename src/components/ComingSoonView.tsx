              ...
              <AnimatePresence mode="wait">
                {status === "success" ? (
                  ...
                  <form onSubmit={handleSubscribe} className="relative group">
                    <div className="relative flex flex-col gap-4 bg-white p-3 rounded-[28px] shadow-xl shadow-slate-200/50 border border-slate-300 hover:border-slate-300 transition-colors">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, idx) => (
              <motion.div 
                ...
                className="group p-8 bg-slate-50 hover:bg-slate-100 rounded-3xl transition-all duration-300 border border-slate-300"
              >
